"""
UI components including CSS styling, forms, and display functions
"""
...
def display_loading_animation():
    ...
    <div class="loading-container">
        <div class="workout-animation">💪</div>
...
def display_form(generator, is_edit=False):
    ...
    with st.form("workout_form", clear_on_submit=not is_edit):
        ...
        if submitted:
            if not all([name, age, gender, fitness_level, goal, training_days_per_week, session_duration]):
